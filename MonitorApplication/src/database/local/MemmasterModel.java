...
public class MemmasterModel {
    ...
    private Float Member_ServiceCount;
    ...
    private String Member_PriceNO;
    private Date System_Created;
    private Date System_Updated;
    ...
    public Float getMember_ServiceCount() {
        return Member_ServiceCount;
    }

    public void setMember_ServiceCount(Float Member_ServiceCount) {
    ...
    public String getMember_TranferFlag() {
        return Member_TranferFlag;
    }

    public void setMember_TranferFlag(String Member_TranferFlag) {
        this.Member_TranferFlag = Member_TranferFlag;
    }
    ...
    public String getMember_PriceNO() {
        return Member_PriceNO;
    }

    public void setMember_PriceNO(String Member_PriceNO) {
        this.Member_PriceNO = Member_PriceNO;
    }

    public Date getSystem_Created() {
        return System_Created;
    }

    public void setSystem_Created(Date System_Created) {
        this.System_Created = System_Created;
    }

    public Date getSystem_Updated() {
        return System_Updated;
    }

    public void setSystem_Updated(Date System_Updated) {
        this.System_Updated = System_Updated;
    }

    @Override
    public String toString() {
        return "MemmasterModel{" + "Member_Code=" + Member_Code + ", Member_TypeCode=" + Member_TypeCode + ", Member_BranchCode=" + Member_BranchCode + ", Member_NameThai=" + Member_NameThai + ", Member_NameEng=" + Member_NameEng + ", Member_Gender=" + Member_Gender + ", Member_Status=" + Member_Status + ", Member_NationCode=" + Member_NationCode + ", Member_OccupationCode=" + Member_OccupationCode + ", Member_IncomeCode=" + Member_IncomeCode + ", Member_EducationCode=" + Member_EducationCode + ", Member_Company=" + Member_Company + ", Member_AddressNo=" + Member_AddressNo + ", Member_Building=" + Member_Building + ", Member_AddressSoi=" + Member_AddressSoi + ", Member_AddressStreet=" + Member_AddressStreet + ", Member_AddressSubDistrict=" + Member_AddressSubDistrict + ", Member_AddressDistrict=" + Member_AddressDistrict + ", Member_Province=" + Member_Province + ", Member_PostalCode=" + Member_PostalCode + ", Member_HomeTel=" + Member_HomeTel + ", Member_Fax=" + Member_Fax + ", Member_Email=" + Member_Email + ", Member_Brithday=" + Member_Brithday + ", Member_AppliedDate=" + Member_AppliedDate + ", Member_ExpiredDate=" + Member_ExpiredDate + ", Member_DiscountRate=" + Member_DiscountRate + ", Member_SpouseName=" + Member_SpouseName + ", Member_Food=" + Member_Food + ", Member_TotalPurchase=" + Member_TotalPurchase + ", Member_Remark1=" + Member_Remark1 + ", Member_Remark2=" + Member_Remark2 + ", Member_Mobile=" + Member_Mobile + ", Member_ReceiveInformation=" + Member_ReceiveInformation + ", Member_HobbySetCode=" + Member_HobbySetCode + ", Member_LastDateService=" + Member_LastDateService + ", Member_ServiceCount=" + Member_ServiceCount + ", Member_PointExpiredDate=" + Member_PointExpiredDate + ", Member_TotalScore=" + Member_TotalScore + ", Member_TitleNameThai=" + Member_TitleNameThai + ", Member_SurnameThai=" + Member_SurnameThai + ", Member_CompanyAddressNo=" + Member_CompanyAddressNo + ", Member_CompanyBuilding=" + Member_CompanyBuilding + ", Member_CompanySoi=" + Member_CompanySoi + ", Member_CompanyStreet=" + Member_CompanyStreet + ", Member_CompanySubDistrict=" + Member_CompanySubDistrict + ", Member_CompanyDistrict=" + Member_CompanyDistrict + ", Member_CompanyProvince=" + Member_CompanyProvince + ", Member_CompanyPostalCode=" + Member_CompanyPostalCode + ", Member_CompanyTel=" + Member_CompanyTel + ", Member_CompanyFax=" + Member_CompanyFax + ", Member_Active=" + Member_Active + ", Member_UsedTitle=" + Member_UsedTitle + ", Member_MailTo=" + Member_MailTo + ", Member_PrintLabel=" + Member_PrintLabel + ", Employee_CodeCreate=" + Employee_CodeCreate + ", Employee_CreateDate=" + Employee_CreateDate + ", Employee_CreateTime=" + Employee_CreateTime + ", Employee_CodeModify=" + Employee_CodeModify + ", Employee_ModifyDate=" + Employee_ModifyDate + ", Employee_ModifyTime=" + Employee_ModifyTime + ", Member_TranferFlag=" + Member_TranferFlag + ", Member_UnknowBirth=" + Member_UnknowBirth + ", Member_PriceNO=" + Member_PriceNO + ", System_Created=" + System_Created + ", System_Updated=" + System_Updated + '}';
    }
